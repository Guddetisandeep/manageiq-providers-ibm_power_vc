module ManageIQ::Providers::IbmPowerVc::CloudManager::EventParser
    def self.event_to_hash(event, ems_id)
        ManageIQ::Providers::IbmPowerVc::EventParserCommon.event_to_hash(event, ems_id) do |event_hash, payload|
